...
const de = {
  ...
  installGuide: {
    ...
    intro: "So bekommst du ein eigenes App-Symbol auf deinem Homescreen – ganz ohne App Store.",
    iosTitle: "📱 iPhone / iPad (Safari)",
    iosStep1: "isybee in Safari öffnen",
    iosStep2: "Unten auf das Teilen-Symbol tippen (Quadrat mit Pfeil nach oben)",
    iosStep3: "„Zum Home-Bildschirm“ auswählen",
    iosStep4: "Oben rechts auf „Hinzufügen“ tippen",
...
const en: Dict = {
  ...
  installGuide: {
    ...
    intro: "Get your own app icon on your home screen – no app store needed.",
    iosTitle: "📱 iPhone / iPad (Safari)",
    iosStep1: "Open isybee in Safari",
    iosStep2: "Tap the Share icon at the bottom (square with an arrow pointing up)",
