...
const de = {
  ...
  installGuide: {
    ...
    heading: "isybee als App installieren",
    intro: "So bekommst du isybee als eigene App auf dein Gerät.",
    androidTitle: "🤖 Android (Chrome)",
    androidStep1: "isybee in Chrome öffnen",
    androidStep2: "Oben rechts auf die drei Punkte (⋮) tippen",
    androidStep3: "„App installieren“ auswählen",
    androidStep4: "Mit „Installieren“ bestätigen",
    iosTitle: "📱 iPhone / iPad",
    iosText: "Für iPhone und iPad gibt es isybee als eigene App im App Store.",
    iosButton: "Im App Store öffnen",
  ...
  voiceNotes: {
    toggleLabel: "🎙️ Sprachnotizen",
    recordStart: "Sprachnotiz aufnehmen",
    recording: (elapsed: string) => `Aufnahme läuft … ${elapsed} – zum Beenden tippen`,
    saveButton: "Aufnahme speichern?",
    saving: "Speichere…",
    discardButton: "Verwerfen",
    saved: "Sprachnotiz gespeichert.",
    reviewButtonLabel: "🎙️ Gespeicherte Sprachnotizen",
    reviewHeading: (label: string) => `🎙️ Sprachnotizen – ${label}`,
    empty: "Für diesen Stock gibt es noch keine Sprachnotizen.",
    deleteBtn: "Löschen",
    deleteConfirm: "Diese Sprachnotiz endgültig löschen? Das kann nicht rückgängig gemacht werden.",
    errUnsupported: "Sprachaufnahme wird auf diesem Gerät bzw. in diesem Browser nicht unterstützt.",
    errPermission: "Kein Zugriff auf das Mikrofon. Bitte in den Geräteeinstellungen für isybee erlauben.",
    errUpload: "Sprachnotiz konnte nicht gespeichert werden. Bitte Internetverbindung prüfen.",
    errLoad: "Sprachnotizen konnten nicht geladen werden.",
...
const en: Dict = {
  ...
  installGuide: {
    ...
    heading: "Install isybee as an app",
    intro: "Here's how to get isybee as its own app on your device.",
    androidTitle: "🤖 Android (Chrome)",
    androidStep1: "Open isybee in Chrome",
    androidStep2: "Tap the three dots (⋮) in the top right",
    androidStep3: "Select “Install app”",
    androidStep4: "Confirm with “Install”",
    iosTitle: "📱 iPhone / iPad",
    iosText: "For iPhone and iPad, isybee is available as its own app in the App Store.",
    iosButton: "Open in the App Store",
  ...
  voiceNotes: {
    toggleLabel: "🎙️ Voice notes",
    recordStart: "Record a voice note",
    recording: (elapsed: string) => `Recording … ${elapsed} – tap to stop`,
    saveButton: "Save recording?",
    saving: "Saving…",
    discardButton: "Discard",
    saved: "Voice note saved.",
    reviewButtonLabel: "🎙️ Saved voice notes",
    reviewHeading: (label: string) => `🎙️ Voice notes – ${label}`,
    empty: "There are no voice notes for this hive yet.",
    deleteBtn: "Delete",
    deleteConfirm: "Permanently delete this voice note? This cannot be undone.",
    errUnsupported: "Voice recording isn't supported on this device or browser.",
    errPermission: "No access to the microphone. Please allow it for isybee in your device settings.",
    errUpload: "Could not save the voice note. Please check your internet connection.",
    errLoad: "Could not load voice notes.",
