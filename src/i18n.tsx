...
const de = {
  ...
  voiceNotes: {
    menuLabel: "🎙️ Sprachnotizen",
    heading: "🎙️ Sprachnotizen",
    recordStart: "Aufnahme starten",
    recording: (elapsed: string) => `Aufnahme läuft … ${elapsed} – zum Beenden tippen`,
    hiveLabel: "Stock (optional)",
    hiveNone: "Keinem Stock zugeordnet",
    saveButton: "Speichern",
    saving: "Speichere…",
    discardButton: "Verwerfen",
    empty: "Noch keine Sprachnotizen vorhanden.",
    deleteBtn: "Löschen",
...
const en: Dict = {
  ...
  voiceNotes: {
    menuLabel: "🎙️ Voice notes",
    heading: "🎙️ Voice notes",
    recordStart: "Start recording",
    recording: (elapsed: string) => `Recording … ${elapsed} – tap to stop`,
    hiveLabel: "Hive (optional)",
    hiveNone: "Not assigned to a hive",
    saveButton: "Save",
    saving: "Saving…",
